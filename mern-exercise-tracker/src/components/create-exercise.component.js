...
export default class CreateExercise extends Component {
    ...
    //lifecycle component that will be called right before anything is displayed on the page
    componentDidMount(){
    ...
    onChangeUsername (e){
        //always use setState to change the var value
        this.setState({
    ...
    onSubmit (e){
        //prevent the default submit behavior of HTML
        e.preventDefault();
